...
class MockVideoModel(VideoModel):
    ...
    async def extend(self, req: Any) -> VideoGenResult:
        # Implementation of ExtendRequest is similar to generate
        # For brevity in mocks, we'll just use a simplified version or raise error if needed
        raise NotImplementedError("Mock extend not implemented")

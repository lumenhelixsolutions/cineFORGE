...
- Name: full_lifecycle.spec.ts >> CineForge UI - Full Project Lifecycle (Mocked) >> should allow uploading a source document
- Location: tests\e2e\full_lifecycle.spec.ts:47:3
